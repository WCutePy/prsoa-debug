#ifndef HEADERS_PRSOA_H_
#define HEADERS_PRSOA_H_

#include "versions.h"

// Default to NA if there's no predefined version
#ifndef PRSOA_VERSION
#define PRSOA_VERSION PRSOA_NA
#endif

#ifndef PRSOA_UNSIZED_HEADERS
...
// ======== END NORMAL PREAMBLE ========
#else // #ifndef PRSOA_UNSIZED_HEADERS
...
// prsoa-debug headers, without caring about the specifics of struct sizing and memory layouts.
// The intent is to allow applications to do something like:
// ```
// #define PRSOA_UNSIZED_HEADERS
// #include "prsoa-debug/headers/prsoa.h"
// #undef PRSOA_UNSIZED_HEADERS
// ```
//
...
// PRSOA_UNSIZED_HEADERS implies PRSOA_NO_BUILTIN, because trying to declare certain builtins
// will cause the compiler to complain in many typical contexts.
#ifndef PRSOA_NO_BUILTIN
#define PRSOA_NO_BUILTIN
#endif
...
#endif // #ifndef PRSOA_UNSIZED_HEADERS
