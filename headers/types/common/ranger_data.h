...
// I have reason to doubt this struct is as long as it is. I may be splitting it, but until I'm sure I want it split, it's going to be ranger_data_old...
...
ASSERT_SIZE(struct ranger_data_old, 35688);
