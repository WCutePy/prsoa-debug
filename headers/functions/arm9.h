...
void SetPlayerExp(struct ranger_data* param_1, unsigned int32_t param_2);
int32_t AddPlayerExp(struct ranger_data* param_1, int32_t param_2);
void SetMaxStepsRecord(struct ranger_data* param_1, unsigned int32_t param_2);
int32_t AddMaxStepsRecord(struct ranger_data* param_1, int32_t param_2);
void SetConversationsRecord(struct ranger_data* param_1, unsigned int32_t param_2);
int32_t AddConversationsRecord(struct ranger_data* param_1, int32_t param_2);
void SetTargetsCheckedRecord(struct ranger_data* param_1, unsigned int32_t param_2);
int32_t AddTargetsCheckedRecord(struct ranger_data* param_1, int32_t param_2);
void SetGameSavesRecord(struct ranger_data* param_1, unsigned int32_t param_2);
int32_t AddGameSavesRecord(struct ranger_data* param_1, int32_t param_2);
void SetPokemonRidesRecord(struct ranger_data* param_1, unsigned int32_t param_2);
...
void SetCaptureLineLenRecord(struct ranger_data* param_1, unsigned int32_t param_2);
int32_t AddCaptureLineLenRecord(struct ranger_data* param_1, int32_t param_2);
void SetNumLoopsRecord(struct ranger_data* param_1, unsigned int32_t param_2);
...
undefined4 BitorPartnerPokemonStatus(unsigned int32_t* param_1);
unsigned int32_t BitandPartnerPokemonStatus(unsigned int32_t* param_1);
...
undefined4 * Init2x2IdentityMatrix(undefined4 *param_1);
undefined4 *PopulateUpperHemisphereOfRotMatrix(undefined4 *param_1,undefined4 param_2,undefined4 param_3);
undefined4 * Mtx_Identity33(undefined4 *param_1);
void MatrixRotZ(undefined4 *param_1,int param_2,undefined4 param_3);
undefined4 * Mtx_Identity(undefined4 *param_1);
void Mtx_TransApply(int *param_1,int *param_2,int param_3,int param_4,int param_5);
void ScaleMatrix(unsigned int *param_1,unsigned int *param_2,int param_3,int param_4,int param_5);
undefined4 * Mtx_RotZ(undefined4 *param_1,int param_2,undefined4 param_3);
void FixedPoint4x4MatrixMultiply(int *param_1,unsigned int *param_2,unsigned int *param_3,undefined4 param_4);
void Mtx_Ortho(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,unsigned int param_7,int *param_8);
unsigned int FixedPointDivide32(int32_t param_1,int32_t param_2);
int64_t Divide32HighBy32Low(int32_t param_1,int32_t param_2);
unsigned int GetFixedPointReciprocal(int param_1);
int Sqrt32(int param_1);
int InverseSqrt(int param_1);
int64_t Division64Return(void);
unsigned int FixedPointDivision32Return(void);
void InitFixedPointReciprocal(int param_1);
void InitSqrt32High(int param_1);
unsigned int GetSqrtResultUpper(void);
void InitDivision32HighBy32Low(int32_t param_1,int32_t param_2);
int Divide32By32Quotient(int param_1,int param_2);
int Divide32by32Remainder(int param_1,int param_2);
...
int GetFixedPointArcTanFromTable(int param_1);
int GetFixedPointArcTan2FromTable(int param_1,int param_2);
int16_t ArcTan2FromTable16(int param_1,int param_2);
...
void OS_SetIrqFunction(unsigned int32_t intr_bit, os_irq_function function);
unsigned int32_t OS_SetIrqMask(unsigned int32_t mask);
unsigned int32_t OS_EnableIrqMask(unsigned int32_t mask);
unsigned int32_t OS_DisableIrqMask(unsigned int32_t mask);
unsigned int32_t OS_ResetRequestIrqMask(unsigned int32_t mask);
void OS_SetIrqStackChecker(void);
void OS_InitLock(void);
int32_t OS_LockByWord(unsigned int16_t lock_id, struct os_lock_word* lockp, lock_ctrl_funcp ctrl_funcp);
int32_t OS_UnlockByWord(unsigned int16_t lock_id, struct os_lock_word* lockp, lock_ctrl_funcp ctrl_funcp);
int32_t OS_UnlockCartridge(unsigned int16_t lock_id);
int32_t OS_UnlockCartridgeVeneer(unsigned int16_t lock_id);
...
void DC_InvalidateRange(void* start_addr, unsigned int32_t n_bytes);
void DC_FlushRange(void* data, unsigned int32_t size);
...
void OS_SetProtectionRegion1(unsigned int32_t param);
void OS_SetProtectionRegion2(unsigned int32_t param);
...
void OS_GetMacAddress(unsigned int8_t* macAddress);
void OS_GetOwnerInfo(struct user_settings* settings);
unsigned int32_t Math_CountLeadingZeros(unsigned int32_t x);
void OSi_InitVramExclusive(void);
void OS_Panic(void);
void OS_Halt(void);
void MI_SetWramBank(enum mi_wram cnt);
void MI_DmaCopy16(unsigned int32_t dma_no, void* src, void* dest, unsigned int32_t size);
void MI_StopDma(unsigned int32_t dma_no);
void MIi_CheckDma0SourceAddress(unsigned int32_t dma_no, unsigned int32_t src, unsigned int32_t size, unsigned int32_t dir);
void MIi_CpuClear16(unsigned int16_t val, void* ptr, int32_t len);
void MIi_CpuCopy16(void* src, void* dest, int32_t len);
void MIi_CpuClear32(unsigned int32_t val, void* ptr, int32_t len);
void MIi_CpuCopy32(void* src, void* dest, int32_t len);
void MIi_CpuClearFast(unsigned int32_t val, void* ptr, int32_t len);
void MIi_CpuCopyFast(void* src, void* dest, int32_t len);
void MI_CpuFill8(void* ptr, char val, unsigned int32_t len);
void MI_CpuCopy8(void* src, void* dest, unsigned int32_t n);
void MI_Init(void);
unsigned int16_t Snd_CalcChannelVolume(int32_t value);
void Pxi_Init(void);
...
int32_t Pxi_SendWordByFifo(int32_t fifo_tag, unsigned int32_t data, bool err);
void Pxii_HandlerRecvFifoNotEmpty(void);
void PMi_CallCallbackAndUnlock(void);
void PM_Init(void);
void PMi_CommonCallback(void);
unsigned int32_t PM_ForceToPowerOff(void);
void Cardi_InitCommon(void);
void Card_Enable(bool enable);
bool Cardi_ReadFromCache(struct card_rom_stat* p);
void Cardi_SetRomOp(unsigned int32_t cmd1, unsigned int32_t cmd2);
void Cardi_ReadCard(struct card_rom_stat* p);
void Card_Init(void);
void Cardi_OnFifoRecv(enum pxi_fifo_tag tag, unsigned int32_t data, bool err);
...
void Ctrdgi_LockByProcessor(unsigned int16_t lock_id, struct ctrdg_lock_by_proc* info);
void Ctrdgi_UnlockByProcessor(unsigned int16_t lock_id, struct ctrdg_lock_by_proc* info);
void Ctrdgi_SendtoPxi(unsigned int32_t data);
...
bool TryAssignByte(unsigned int8_t* ptr, unsigned int8_t val);
bool TryAssignByteWrapper(unsigned int8_t* ptr, unsigned int8_t val);
...
void _u32_div_f(unsigned int32_t param_1, unsigned int32_t param_2);
void _u32_div_not_0_f(unsigned int32_t param_1, unsigned int32_t param_2);
