...
uint SysCallFixedPointMultiply(int *param_1);
void SysCallFixedPointDivide(undefined4 *param_1);
int SysCallGetTrigTableSin(uint *param_1);
int SysCallGetTrigTableCos(uint *param_1);
uint SysCallGetTaylorPackedSinCos(undefined4 *param_1);
uint SysCallGetTaylorPackedCosSin(uint *param_1);
uint SysCallGetLcrngHigh(uint *param_1);
uint SysCallFixedPointRandomScale(int *param_1);
...
uint SysCallFixedPointRadToDeg(uint *param_1);
...
uint SysCallFloorFixedPoint(uint *param_1);
...
void ScaleMatrix(uint *param_1,uint *param_2,int param_3,int param_4,int param_5);
undefined4 * MTX_RotZ(undefined4 *param_1,int param_2,undefined4 param_3);
void FixedPoint4x4MatrixMultiply(int *param_1,uint *param_2,uint *param_3,undefined4 param_4);
void MTX_Ortho(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,uint param_7,int *param_8);
uint FixedPointDivide32(int32_t param_1,int32_t param_2);
int64_t Divide32HighBy32Low(int32_t param_1,int32_t param_2);
uint GetFixedPointReciprocal(int param_1);
int Sqrt32(int param_1);
int InverseSqrt(int param_1);
int64_t Division64Return(void);
uint FixedPointDivision32Return(void);
void InitFixedPointReciprocal(int param_1);
void InitSqrt32High(int param_1);
uint GetSqrtResultUpper(void);
