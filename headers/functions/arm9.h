...
bool GetTextboxStatus(textbox_data *param_1);
void CloseTextbox(textbox_data *param_1,int param_2,int param_3);
undefined4 MaybeIsPlayerPressingTextbox(textbox_data *param_1);
undefined4 IsPlayerHoldingButtonsTextbox(textbox_data *param_1);
void SetCustomTextSpeed(textbox_data *param_1,int param_2);
void SetDefaultTextSpeed(textbox_data *param_1);
void EnableAutoAdvanceTextWithDelay(textbox_data *param_1,int param_2);
void DisableAutoAdvanceText(textbox_data *param_1);
void EnableAutoCloseTextWithDelay(textbox_data *param_1,int param_2);
void DisableAutoCloseText(textbox_data *param_1);
...
void PrintTextboxBySystemMessageId(textbox_data *param_1,uint param_2,int param_3,int param_4,undefined4 param_5);
void PrintTextboxByAreaMessageId(textbox_data *param_1,uint param_2,int param_3,int param_4,undefined4 param_5);
void PrintTextboxByChapterMessageId(textbox_data *param_1,uint param_2,int param_3,int param_4,undefined4 param_5);
void PrintTextboxByQuestMessageId(textbox_data *param_1,uint param_2,int param_3,int param_4,undefined4 param_5);
void PrintTextboxByBattleMessageId(textbox_data *param_1,uint param_2,int param_3,int param_4,undefined4 param_5);
undefined4 TryCloseTextbox(textbox_data *param_1,undefined4 param_2);
int GetYesNoMenuResult(textbox_data *param_1);
...
void SysCallGetTextboxStatus(void);
...
undefined4 SysCallSetRangerHP(uint *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4);
int8_t SysCallRangerMaxHp(void);
...
undefined4 SysCallPrintStr(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4);
undefined4 SysCallDebugPrintf(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4);
uint SysCallBitAndUpper5Nibbles(uint *param_1);
