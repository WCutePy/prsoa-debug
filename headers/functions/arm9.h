...
void MaybeMemAlloc(undefined4 param_1);
touch_screen_wrapper * InitTouchScreenWrapper(touch_screen_wrapper *param_1);
touch_screen * InitTouchScreen(touch_screen *param_1);
void ret_02001eb4(void);
void ret_02001ecc(void);
touch_screen_wrapper * InitTouchScreenWrapperOuter(touch_screen_wrapper *param_1);
void MaybeMemFree(void *param_1);
file_archive_wrapper *InitFileArchiveWrapper(file_archive_wrapper *param_1,undefined4 param_2,char *param_3,int param_4,undefined4 param_5,int param_6,int param_7);
file_wrapper *InitFileWrapper(file_wrapper *param_1,char *param_2,int param_3,undefined4 param_4,int param_5,int param_6);
...
font_file_data * InitFontFileData(font_file_data *param_1);
param_file_data * ZeroInitParamFileData(param_file_data *param_1,undefined4 param_2);
param_file_data * MaybeDeallocateParamFileDataOuter(param_file_data *param_1);
void InitParamFileData(param_file_data *param_1,char *param_2);
void MaybeDeallocateParamFileData(param_file_data *param_1);
void SchemaExpandParamFileData(param_file_data *param_1);
int GetParamRamTableEntrySize(param_file_data *param_1);
bool ParamGetExpandedRamTableFieldInner(param_file_data *param_1,int param_2,int param_3,int *param_4);
undefined4 ParamGetExpandedRamTableFieldOuter(param_file_data *param_1,int param_2,int param_3,undefined4 *param_4);
...
battle_combatants * InitBattleCombatantsOuter(battle_combatants *param_1);
...
disk_hp_table_wrapper * InitDiskHpTableWrapper(disk_hp_table_wrapper *param_1,undefined4 param_2);
...
void ZeroQuestBodyVeneer(struct mission_quest_data* param_1);
...
void CalcDateAndTime(struct ranger_data_old* param_1, struct rtc_time* param_2,
                     struct rtc_date* param_3);
...
void SetCurrentRangerPlaytime(struct ranger_data_old* param_1, int param_2, int8_t param_3,
                              int8_t param_4);
...
undefined4 SysCallMaybeDoIrisTransition(uint32_t* param_1);
...
struct field_npc_data* GetFieldNpcDataBySpriteId(struct field_data* param_1,
                                                 enum npc_sprite param_2);
struct field_enemy_data* GetFieldEnemyDataByFormId(struct field_data* param_1,
                                                   enum form_id param_2);
struct field_target_data* GetFieldTargetDataByIndex(struct field_data* param_1,
                                                    enum target_object param_2);
...
void GX_LoadBg2Scr(int param_1, int param_2, uint32_t param_3);
void GXs_LoadBg2Scr(int param_1, int param_2, uint32_t param_3);
void GX_LoadBg3Scr(int param_1, int param_2, uint32_t param_3);
