...
undefined4 * MTX_Identity22_(undefined4 *param_1);
undefined4 * MTX_Scale22_(undefined4 *param_1,undefined4 param_2,undefined4 param_3);
undefined4 * MTX_Identity33_(undefined4 *param_1);
void MTX_RotZ33_(undefined4 *param_1,int param_2,undefined4 param_3);
undefined4 * MTX_Identity44_(undefined4 *param_1);
void MTX_TransApply44(int *param_1,int *param_2,int param_3,int param_4,int param_5);
void MTX_ScaleApply44(uint *param_1,uint *param_2,int param_3,int param_4,int param_5);
undefined4 * MTX_RotZ44_(undefined4 *param_1,int param_2,undefined4 param_3);
void FixedPoint4x4MatrixMultiply(int (*param_1) [4] [4],uint (*param_2) [4] [4],uint (*param_3) [4] [4],undefined4 param_4);
void MTX_OrthoW(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,uint param_7,int *param_8);
void ret_0206129c(void);
void GX_Init(void);
void GX_SetVCountEqVal(uint param_1);
...
void OS_WaitIrq(int param_1,uint param_2);
...
void Maybe_OSi_GetUnusedThreadId(void);
...
void Maybe_OS_CreateThread(thread *param_1,undefined4 param_2,uint32_t param_3,void *param_4,int param_5,int param_6);
void Maybe_OS_JoinThread(thread *param_1);
...
uint OS_GetDTCMAddress(void);
uint OS_EnableProtectionUnit(void);
uint OS_DisableProtectionUnit(void);
void OS_SetDPermissionsForProtectionRegion(uint param_1,uint param_2);
...
void OS_SpinWait(uint param_1);
void OS_WaitVBlankIntr(void);
void OS_InitReset(void);
void OSi_CommonCallback(undefined4 param_1,uint param_2);
...
void MI_DmaFill32(int param_1,undefined4 param_2,undefined4 param_3,uint param_4);
void MI_DmaSend32(int param_1,undefined4 param_2,undefined4 param_3,uint param_4);
void MI_DmaFill16(int param_1,undefined4 param_2,undefined4 param_3,uint param_4);
void MI_DmaCopy16(uint32_t dma_no, void* src, void* dest, uint32_t size);
void MI_StopDma(uint32_t dma_no);
void MIi_CheckAnotherAutoDMA(int param_1,uint param_2);
...
undefined8 MI_Copy36B(undefined4 *param_1,undefined4 *param_2);
undefined8 MI_Copy48B(undefined4 *param_1,undefined4 *param_2);
...
undefined2 *TP_CalcCalibrateParam(undefined2 *param_1,undefined2 *param_2,uint param_3,uint param_4,uint16_t param_5,uint16_t param_6,uint16_t param_7,uint16_t param_8,uint16_t param_9);
...
undefined4 PMi_SendSleepStart(uint param_1,uint param_2);
undefined4 PM_SendUtilityCommandAsync(uint param_1,undefined4 param_2,undefined4 param_3);
undefined4 PMi_ReadRegisterAsync(uint param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4);
...
void PM_GetBackLight(uint *param_1,uint *param_2,undefined4 param_3,uint param_4);
void PMi_SendPxiData(undefined4 param_1);
void PM_GoSleepMode(uint param_1,uint16_t param_2,uint16_t param_3,undefined4 param_4);
...
undefined4 PMi_SendLEDPatternCommandAsync(uint param_1,undefined4 param_2,undefined4 param_3);
...
void RtcCommonCallback(undefined4 param_1,uint param_2,int param_3,undefined4 param_4);
int RtcBCD2HEX(uint param_1);
...
bool RtcSendPxiCommand(uint param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4);
int RTC_ConvertDateToDay(uint *param_1);
int RTCi_ConvertTimeToSecond(int *param_1);
int RTC_ConvertDateTimeToSecond(undefined4 param_1,undefined4 param_2);
undefined8 RTC_GetDayOfWeek(int *param_1);
...
void CARDi_ReadRom(uint param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,undefined4 param_6,int param_7);
void Card_Init(void);
...
void CARDi_PulledOutCallback(undefined4 param_1,uint param_2);
