...
undefined4 IsTriggerSpawnNibbleUnlocked(struct ranger_data *param_1,int param_2,room_id param_3);
void UnlockTriggerSpawnNibble(struct ranger_data *param_1,int param_2,room_id param_3);
void EnableTriggerSpawnNibble(struct ranger_data *param_1,int param_2,room_id param_3);
void UnlockPokemonSpawnNibble(struct ranger_data *param_1,int param_2,uint param_3);
void EnablePokemonSpawnNibble(struct ranger_data *param_1,int param_2,uint param_3);
undefined4 IsNpcSpawnNibbleUnlocked(struct ranger_data *param_1,int param_2,uint param_3);
void UnlockNpcSpawnNibble(struct ranger_data *param_1,int param_2,room_id param_3);
void EnableNpcSpawnNibble(struct ranger_data *param_1,int param_2,uint param_3);
