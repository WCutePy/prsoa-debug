...
void WipeTextboxData(textbox_data *param_1);
...
void InitIrisTransitionStructById(screen_fade *param_1,undefined4 *param_2);
unsigned int ScreenClampValueToRange(screen_fade *param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4);
void ScreenInitStripesForIrisTransition(screen_fade *param_1,int param_2,int param_3);
void ScreenApplyIrisTransitionRadius(screen_fade *param_1,int param_2,int param_3);
int MaybeGetIrisCurrentWidth(screen_fade *param_1);
...
void SetTextboxWindowAndSpeedSettings(megastruct *param_1);
void SetUnkAudioSettingVariables(megastruct *param_1);
bool GetUnkAudioSettingVariables(megastruct *param_1);
void InitUnkAudioSettingVariables(megastruct *param_1);
...
bool IsFormIdPartnerPokemon(form_id param_1);
...
void InitAudioSubstructFileData(unk_audio_engine_substruct_1 *param_1,char *param_2,void *param_3,int param_4);
