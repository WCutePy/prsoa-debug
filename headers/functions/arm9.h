...
undefined4* PopulateUpperHemisphereOfRotMatrix(undefined4* param_1, undefined4 param_2,
                                               undefined4 param_3);
...
void ScaleMatrix(unsigned int* param_1, unsigned int* param_2, int param_3, int param_4,
                 int param_5);
undefined4* Mtx_RotZ(undefined4* param_1, int param_2, undefined4 param_3);
void FixedPoint4x4MatrixMultiply(int* param_1, unsigned int* param_2, unsigned int* param_3,
                                 undefined4 param_4);
void Mtx_Ortho(int param_1, int param_2, int param_3, int param_4, int param_5, int param_6,
