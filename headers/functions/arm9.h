...
void PrintTextboxBySystemMessageId(struct textbox_data *param_1,uint32_t param_2,int param_3,int param_4,undefined4 param_5);
void PrintTextboxByAreaMessageId(struct textbox_data *param_1,uint32_t param_2,int param_3,int param_4,undefined4 param_5);
void PrintTextboxByChapterMessageId(struct textbox_data *param_1,uint32_t param_2,int param_3,int param_4,undefined4 param_5);
void PrintTextboxByQuestMessageId(struct textbox_data *param_1,uint32_t param_2,int param_3,int param_4,undefined4 param_5);
void PrintTextboxByBattleMessageId(struct textbox_data *param_1,uint32_t param_2,int param_3,int param_4,undefined4 param_5);
...
undefined4 SysCallSetRangerCurrentHp(uint32_t *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4);
