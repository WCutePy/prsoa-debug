...
megastruct * InitMegastruct(megastruct *param_1);
megastruct * GetMegastructPointer(void);
...
void ZeroPokemonData(pokemon_data *param_1);
...
pokemon_data * RetrievePokemonDataFromTable(struct struct ranger_data *param_1,int param_2);
undefined4 IsTriggerSpawnNibbleUnlocked(struct struct ranger_data *param_1,int param_2,room_id param_3);
void UnlockTriggerSpawnNibble(struct struct ranger_data *param_1,int param_2,room_id param_3);
void EnableTriggerSpawnNibble(struct struct ranger_data *param_1,int param_2,room_id param_3);
void UnlockPokemonSpawnNibble(struct struct ranger_data *param_1,int param_2,uint param_3);
void EnablePokemonSpawnNibble(struct struct ranger_data *param_1,int param_2,uint param_3);
undefined4 IsNpcSpawnNibbleUnlocked(struct struct ranger_data *param_1,int param_2,uint param_3);
void UnlockNpcSpawnNibble(struct struct ranger_data *param_1,int param_2,room_id param_3);
void EnableNpcSpawnNibble(struct struct ranger_data *param_1,int param_2,uint param_3);
