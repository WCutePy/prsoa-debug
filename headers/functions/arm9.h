...
file_wrapper * InitFileWrapperWithLangSuffix(file_wrapper *param_1,undefined4 param_2,int param_3);
...
void ZeroInitTextboxData(textbox_data *param_1);
...
int FillPokemonNameMsgWrapper(group_msg_wrapper_table *param_1);
void ZeroPkmnNameMsgWrapper(group_msg_wrapper_table *param_1);
undefined4 * FillItemNameMsgWrapper(group_msg_wrapper_table *param_1);
void ZeroItemNameMsgWrapper(group_msg_wrapper_table *param_1);
undefined4 * FillTargetNameMsgWrapper(group_msg_wrapper_table *param_1);
void ZeroTargetNameMsgWrapper(group_msg_wrapper_table *param_1);
undefined4 * FillNpcNameMsgWrapper(group_msg_wrapper_table *param_1);
void ZeroNpcNameMsgWrapper(group_msg_wrapper_table *param_1);
msg_wrapper * FillFieldMoveNameMsgWrapper(group_msg_wrapper_table *param_1);
void ZeroFieldMoveNameMsgWrapper(group_msg_wrapper_table *param_1);
char * GetPokemonNameById(group_msg_wrapper_table *param_1,int param_2);
char * GetItemNameById(group_msg_wrapper_table *param_1,int param_2);
char * GetTargetNameById(group_msg_wrapper_table *param_1,int param_2);
char * GetNpcNameById(group_msg_wrapper_table *param_1,int param_2);
char * GetFieldMoveNameById(group_msg_wrapper_table *param_1,int param_2);
...
int64_t TaylorExpandFixedPointSin(uint angle,int amplitude);
int64_t TaylorExpandFixedPointCos(uint angle,int amplitude);
int64_t GetFixedPointSinCos(uint param_1);
int64_t GetFixedPointCosSin(uint param_1);
